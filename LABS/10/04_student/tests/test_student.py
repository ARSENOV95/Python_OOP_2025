...
class StudentTest(TestCase):
    def setUp(self):
        self.student_1 = Student("Student 1",
                                 {'Python':['n1','n2,','n3'],
                                          "JS":["n1","n2"]})
    ...
    def test_enroll_in_not_existing_course_with_notes_with_y(self):
        result = self.student_1.enroll("C#",['n1','n2'],'Y')
        self.assertIn("C#",self.student_1.courses) #check if value in parameter
        self.assertEqual("Course and course notes have been added.",result)
        self.assertEqual(['n1','n2'],self.student_1.courses['C#'])

    def test_enroll_in_not_existing_course_with_notes_with_empty_string(self):
        result = self.student_1.enroll("C#",['n1','n2'],'')
        self.assertIn("C#",self.student_1.courses) #check if value in parameter
        self.assertEqual("Course and course notes have been added.",result)
        self.assertEqual(['n1','n2'],self.student_1.courses['C#'])

    def test_enroll_in_not_existing_course_without_notes(self):
    ...
    def add_notes_to_existing_course(self):
        self.student_2.enroll("C#", ['n1', 'n2'], 'Y')
        result = self.student_2.add_notes("C#","n3")

        self.assertEqual("Notes have been updated",self.student_2.courses["C#"])
        self.assertEqual(["n1","n2","n3"],self.student_2.courses["C#"])

    def test_add_notes_to_not_existing(self):
    ...
    def test_leave_not_existing(self):
        with self.assertRaises(Exception) as ex:
            self.student_2.leave_course("C#")
