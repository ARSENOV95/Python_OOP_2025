...
class ComputerStoreApp:
    VALID_COMPUTER_TYPES:dict[str,type[Computer]] = {"Desktop Computer": DesktopComputer
                            ,"Laptop": Laptop
                            } # правим директна референция към класа комшютър, type[Computer] позволява да се позанята дъщерни класове
    ...
    def build_computer(self, type_computer: str, manufacturer: str, model: str, processor: str, ram: int):
        ...
        #вдигаме инстакиця на класа чрез референцията от итпа който пдоаваме
